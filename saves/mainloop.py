        ...
        for event in pygame.event.get():
            ...
            if not self.game.is_finished:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    clicked_piece = self.check_MouseButtonDown(board, dragger)
                    self.game.update(clock.get_fps())
                ...
                # Clique relâché (gauche ou droit)
                    ...
                    previously_selected_piece = self.check_MouseButtonUp(
...
class Main:
    ...
    def __init__(self):
        ...
        self.ia = AI(random_ai.random_ai, self.game)
    ...
    def player_vs_ia(self, player_color):
        pass

    def ia_vs_ia(self):
        pass

    def player_turn(self, event: pygame.event.Event, clock: pygame.time.Clock, 
            board, dragger, previously_selected_piece):
        if not self.game.is_finished:
            clicked_piece = None
            # Clique enfoncé (gauche ou droit)
            if event.type == pygame.MOUSEBUTTONDOWN:
    ...
    def mainloop(self):
        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                self.player_turn(
                    event, clock, board, dragger, previously_selected_piece
                    )
